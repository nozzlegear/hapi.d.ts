// Type definitions for Hapi with custom interfaces for plugins used by Gearworks.
// Project: http://github.com/spumko/hapi
// Definitions by: Jason Swearingen <http://github.com/jasonswearingen>, Joshua Harms <https://github.com/nozzlegear>
...
export interface ServerCache
{
    ...
    provision(options: CacheProvisionOptions): IPromise<void>
...
export interface IReply {
    ...
    <T>(err: BoomError, result?: any | T, credentialData?: any): Response;
...
export interface IRouteConfiguration {
	...
	handler: ISessionHandler | string | IRouteHandlerConfig | { async: ISessionHandler | string | IRouteHandlerConfig };
